...
<body>
  ...
  <section>
    <h2>Kalkulator binarny (8 bitów)</h2>
    <p class="info">Kliknij w bit, by zmienić liczbę<br /></p>
   ...
   <section>
    <h2>Kalkulator dziesiętny</h2>
    <p class="info">Kliknij w liczbę, by ją zmienić<br /></p>
